...
/*  Created On : 17-jun.-2019 8:39:02 p.m. 				*/
/*  DBMS       : MySql 						*/
/* ---------------------------------------------------- */
...
ALTER TABLE `ingreso` 
 ADD INDEX `IXFK_ingreso_tipovehiculo` (`tipo` ASC)
;
...
ALTER TABLE `ingreso` 
 ADD CONSTRAINT `FK_ingreso_tipovehiculo`
	FOREIGN KEY (`tipo`) REFERENCES `tipovehiculo` (`id`) ON DELETE Restrict ON UPDATE Restrict
;
